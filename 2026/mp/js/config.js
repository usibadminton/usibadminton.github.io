...
const CONFIG = {
  ...
  SCRIPT_URL: "https://script.google.com/macros/s/AKfycbxOTgXkPjetTuLMtMCfb-fcxXTjfhxTxQPByVnTyqcOXu-2kZVLOHCRePr5SfgynUmzDw/exec", // 稍後從 Google Apps Script 取得
...
const CSV_URLS = {
  ...
  ORDERS: `https://docs.google.com/spreadsheets/d/${CONFIG.SHEET_ID}/export?format=csv&gid=${CONFIG.GID.ORDERS}`
};
